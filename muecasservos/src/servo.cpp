...
#define BRAZO 2  // 27 milimetros entre el centro ocular y el brazo de mando del ojo

int Servo::convertir_Radianes_Pasos(float angulo, bool inverted)
{
	if(inverted != true)
		angulo = -angulo;
	...
	///boca chapuza muecas
	//return (1800+(80/0.5) * angulo);   // Convertido a radianes
        return (1800+(80/0.5) * angulo);   // Convertido a radianes
}
