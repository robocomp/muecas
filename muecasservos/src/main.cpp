...
/** \mainpage RoboComp::muecasservos
 *
 * \section intro_sec Introduction
 *
 * The muecasservos component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/muecasservos --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
{
public:
	muecasservos (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
