...
/** \mainpage RoboComp::MuecasControlComp
 *
 * \section intro_sec Introduction
 *
 * The MuecasControlComp component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/MuecasControlComp --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
{
public:
	MuecasControlComp (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
