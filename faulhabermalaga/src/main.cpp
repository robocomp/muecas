...
/** \mainpage RoboComp::FaulhaberMalaga
 *
 * \section intro_sec Introduction
 *
 * The FaulhaberMalaga component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/FaulhaberMalaga --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class FaulhaberMalaga : public RoboComp::Application
{
public:
	FaulhaberMalaga (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::FaulhaberMalaga::initialize()
{
...
int ::FaulhaberMalaga::run(int argc, char* argv[])
{
